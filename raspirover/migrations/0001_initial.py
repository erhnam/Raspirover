# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-09-27 15:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Lecturas',
            fields=[
                ('id_lecturas', models.AutoField(db_column='ID_Lecturas', primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='lecturas',
            name='sensor',
            field=models.ForeignKey(db_column='SensorFK', null=True, on_delete=django.db.models.deletion.CASCADE, to='raspirover.Sensor'),
        ),
        migrations.AddField(
