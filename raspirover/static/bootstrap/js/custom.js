...
function getSelectedChbox(frm) {
	...
	for(var i=0; i<nr_inpfields; i++) {
			...
			if(inpfields[i].type == 'radio' && inpfields[i].checked == true) selchbox.push(inpfields[i].value);
			if(inpfields[i].type == 'text') selchbox.push(inpfields[i].value);
	}
	return selchbox;
}
...
document.getElementById('check').onclick = function(){
	var selchb = getSelectedChbox(this.form);
		...
		alert('Debe rellenar el campo Nombre de Exploración');	
	}
}
...
image6 = new Image();
image6.src = "/media/automaticogris.png";
image6alt = new Image();
image6alt.src = "/media/automatico.png";

image7 = new Image();
image7.src = "/media/manualgris.png";
image7alt = new Image();
image7alt.src = "/media/manual.png";
...
function cambiar6() {
	...
	if (document.getElementById('checkbox_f6').src != image6.src ) {
...
function cambiar7() {
	...
	if (document.getElementById('checkbox_f7').src != image7.src ) {
 		document.getElementById('checkbox_f7').src = image7.src;
 		document.getElementById('checkbox_f6').src = image6alt.src;
	}
	else {
